...
export function FileCreator({ projectSlug, branch, currentPath }: FileCreatorProps) {
  ...
  const handleTemplateChange = (templateKey: string) => {
    ...
    if (templateKey && fileTemplates[templateKey as keyof typeof fileTemplates]) {
          ...
          <div className="lg:col-span-2">
            <Card className="border-blue-200/50 bg-white/70 backdrop-blur-sm">
              <CardHeader>
                ...
                <CardDescription>{isPreview ? "Preview your file content" : "Write your file content"}</CardDescription>
              </CardHeader>
              <CardContent>
                {isPreview ? (
          ...
          <div className="flex items-center space-x-2 text-sm text-blue-700">
            ...
            <span>
              ...
              <code className="bg-blue-100 px-2 py-1 rounded">
                {currentPath ? `${currentPath}/${fileName || "filename"}` : fileName || "filename"}
              </code>
            </span>
          </div>
        </div>
