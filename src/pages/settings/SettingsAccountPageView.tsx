...
interface SettingsAccountPageViewProps {
    ...
    setConfirmNewPw: (confirmNewPw: string) => void;
    setPasswordValid: (passwordValid: boolean) => void;
    togglePasswordVisibility: (filed: string) => void;
    validatePassword: (value: string) => void;
    handleDeleteAccount: () => void;
    handleModifyUser: () => void;
    handleChangePassword: () => void;
}

export default function SettingsAccountPageView({
    userName,
    userEmail,
    isDeleteDialogOpen,
    currentPw,
