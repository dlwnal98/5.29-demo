...
export interface MembersPageViewProps {
  ...
  currentUsers: (UserList | MemberList)[] | undefined;
  ...
  onExpandToggle: (e: React.MouseEvent, userId: string) => void;
                        ...
                        <TableRow
                          ...
                          <TableCell>
                            <Button
                              variant="ghost"
                              size="sm"
                              onClick={(e) => onExpandToggle(e, user.userId)}
                                        ...
                                        <div className="flex items-center space-x-2">
                                          <Switch
                                            ...
                                            onCheckedChange={(checked) => {
                                              onStatusToggle(user.userKey, checked);
                                            }}
