      ...
      <div key={resource.id}>
        <div
          className={`flex items-center gap-2 py-1 px-2 cursor-pointer hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded text-sm ${
            selectedStage.id === resource.id ? "bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300" : ""
          }`}
            ...
            <div key={child.id}>
              ...
              {child.methods.map((method, index) => (
                ...
                >
                  ...
                  <span className="font-mono text-xs bg-green-100 text-green-800 px-1.5 py-0.5 rounded">{method}</span>
                </div>
              ))}
            </div>
          ))}
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">스테이지</h1>
          </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                <div className="border-b border-gray-200 dark:border-gray-700 p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <button className="text-blue-600 hover:text-blue-700 text-sm">정보</button>
                    </div>
                ...
                <div className="p-4">
                  <div className="grid grid-cols-3 gap-6">
                    <div>
                      <div className="space-y-4">
                        <div>
                          <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">스테이지 이름</Label>
                          <div className="mt-1 text-blue-600 font-medium">{selectedStage.name}</div>
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">
                            캐시 클러스터{" "}
                            <button className="text-blue-600 hover:text-blue-700 text-sm ml-1">정보</button>
                          </Label>
                    ...
                    <div>
                      <div className="space-y-4">
                        <div>
                          <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">
                            요율 <button className="text-blue-600 hover:text-blue-700 text-sm ml-1">정보</button>
                          </Label>
                          <div className="mt-1 text-blue-600 font-medium">
                            {selectedStage.throttleRate.toLocaleString()}
                          </div>
                        </div>
                        <div>
                          <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">
                            버스트 <button className="text-blue-600 hover:text-blue-700 text-sm ml-1">정보</button>
                          </Label>
                          <div className="mt-1 text-blue-600 font-medium">
                            {selectedStage.burstRate.toLocaleString()}
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      <div className="space-y-4">
                        <div>
                          <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">웹 ACL</Label>
                  ...
                  <div className="mt-6 space-y-4">
                    ...
                    <div>
                      <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">최근에 배포</Label>
                      <div className="mt-1 text-sm text-gray-600">
                        {selectedStage.lastDeployed}에 {selectedStage.deploymentId}
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                <div className="border-b border-gray-200 dark:border-gray-700 p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <h2 className="text-lg font-semibold text-gray-900 dark:text-white">로그 및 추적</h2>
                      <button className="text-blue-600 hover:text-blue-700 text-sm">정보</button>
                    </div>
                    <Button variant="outline" size="sm">
                      <Edit className="h-4 w-4 mr-1" />
                  ...
                  <div className="grid grid-cols-3 gap-6">
                    <div>
                      <div className="space-y-4">
                        ...
                        <div>
                          <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">X-Ray 추적</Label>
                          <div className="mt-1 flex items-center gap-2">
                            <XCircle className="h-4 w-4 text-gray-400" />
                            <span className="text-sm text-gray-600">비활성</span>
                          </div>
                    ...
                    <div>
                      <div className="space-y-4">
                        <div>
                          <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">세부 지표</Label>
                          <div className="mt-1 flex items-center gap-2">
                            <CheckCircle className="h-4 w-4 text-green-500" />
                            <span className="text-sm text-green-600">비활성</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      <div className="space-y-4">
                        <div>
                          <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">데이터 추적</Label>
                          <div className="mt-1 flex items-center gap-2">
                            <CheckCircle className="h-4 w-4 text-green-500" />
                            <span className="text-sm text-green-600">비활성</span>
                          </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                <Tabs value={activeTab} onValueChange={setActiveTab}>
                  ...
                  <TabsContent value="variables" className="p-4">
                    <div className="space-y-4">
                      <div className="flex items-center justify-between">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">스테이지 변수 (0/0)</h3>
                        <Button variant="outline" size="sm">
                          <Edit className="h-4 w-4 mr-1" />
                          편집
                        </Button>
                      ...
                      <div className="relative">
                        ...
                        <Input placeholder="키로스 찾기" className="pl-10" />
                      </div>
                          ...
                          <TableRow>
                            <TableCell colSpan={2} className="text-center py-12">
                              <div className="text-gray-500">
                                <p className="font-medium">변수 없음</p>
                                <p className="text-sm">스테이지와 관련된 변수가 없습니다.</p>
                              </div>
                            </TableCell>
                          </TableRow>
                        </TableBody>
                  ...
                  <TabsContent value="execution" className="p-4">
                    <div className="text-center py-12">
                      <p className="text-gray-500">실행서 기록이 없습니다.</p>
                    </div>
                  </TabsContent>

                  <TabsContent value="canary" className="p-4">
                    <div className="text-center py-12">
                      <p className="text-gray-500">Canary 설정이 없습니다.</p>
                    </div>
                  </TabsContent>
        ...
        <Dialog open={isEditModalOpen} onOpenChange={setIsEditModalOpen}>
          <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6 py-4">
              ...
              {/* Additional Settings */}
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">추가 설정</h3>
                <div>
                  <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">
                    캐시 설정 <button className="text-blue-600 hover:text-blue-700 text-sm ml-1">정보</button>
                  </Label>
                  <p className="text-xs text-gray-500 mt-1">
                    API 캐시를 활성화하여 엔드포인트의 응답을 캐시할 수 있습니다. 캐시를 사용하면 엔드포인트 대신 직접
                    응답을 제공할 수 있습니다. API에 대한 요청 지연 시간을 줄이고 백엔드에 대한 호출 횟수를 줄일 수
                    있습니다. 자세한 내용은 캐시 크기 기준을 사전 요금을 부과합니다. 자세한 내용은 API Gateway 요금을
                    참조하세요.
                  </p>
                  <div className="flex items-center justify-between mt-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div>
                      <Label className="text-sm font-medium">API 캐시 프로필지원</Label>
                      <p className="text-xs text-gray-500">
                        스테이지에 대한 API 캐시 기능 프로필지원니다. 메서드 수준 캐시 활성화 매개 변수가 있는지
                        확인합니다.
                      </p>
                    </div>
                    <Switch
                      checked={editForm.apiCacheEnabled}
                      onCheckedChange={(checked) => setEditForm({ ...editForm, apiCacheEnabled: checked })}
                    />
                  </div>
                  <div className="flex items-center justify-between mt-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div>
                      <Label className="text-sm font-medium">기본 메서드 수준 개성</Label>
                      <p className="text-xs text-gray-500">
                        이 스테이지에서 모든 GET 메서드에 대해 메서드 수준 캐시를 활성화합니다.
                      </p>
                    </div>
                    <Switch
                      checked={editForm.methodLevelCacheEnabled}
                      onCheckedChange={(checked) => setEditForm({ ...editForm, methodLevelCacheEnabled: checked })}
                    />
                  </div>
                </div>
              </div>
              ...
              {/* Limit Settings */}
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">제한 설정</h3>
                <div className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  <div>
                    <Label className="text-sm font-medium">조절 중</Label>
                    <p className="text-xs text-gray-500">
                      사용자가 API에 작업하는 속도를 수정 수 있는 속도를 제한합니다.
                    </p>
                  </div>
                  <Switch
                    checked={editForm.throttlingEnabled}
                    onCheckedChange={(checked) => setEditForm({ ...editForm, throttlingEnabled: checked })}
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white">방화벽 및 인증서 설정</h3>
                <div>
                  <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setEditForm({ ...editForm, wafProfile: value })}
                  >
                ...
                <div>
                  <Label className="text-sm font-medium text-gray-700 dark:text-gray-300">클라이언트 인증서</Label>
                  <p className="text-xs text-gray-500 mt-1">
                    클라이언트 인증서를 사용하여 스테이지의 백엔드 내에 HTTP 요청이 API Gateway에서 전송되었는지
                    확인합니다.
                  </p>
                  <Select
                    value={editForm.clientCertificate}
                    onValueChange={(value) => setEditForm({ ...editForm, clientCertificate: value })}
                  >
                    <SelectTrigger className="mt-1">
                      <SelectValue />
                    </SelectTrigger>
            ...
            <div className="space-y-4 py-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setCreateStageForm({ ...createStageForm, name: e.target.value })}
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) => setCreateStageForm({ ...createStageForm, description: e.target.value })}
